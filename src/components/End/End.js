        ...
        <div className='hero-body'>
          <div>
              ...
              <Typography variant='body1' style={{ textAlign: 'center', maxWidth: '800px',
                marginLeft: 'auto', marginRight: 'auto', paddingTop: '20px' }}>
                Remember these tips when creating your own passwords! However,
                you should also try to make your passwords memorable. You can
                still use words, but capitalize some letters and put numbers
                and symbols between them. For example, instead of using 
                redcherries2015, you could try something like chErr20iesRE?D
              </Typography>
              <Typography variant='body1' style={{ textAlign: 'center', maxWidth: '800px',
                marginLeft: 'auto', marginRight: 'auto', paddingTop: '20px' }}>
            ...
            <Typography style={{ paddingTop: '20px', textAlign: 'center' }}>
                made with <FavoriteIcon style={{ fontSize: '1.2em', color:
